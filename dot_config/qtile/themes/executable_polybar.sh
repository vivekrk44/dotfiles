...
T_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )"
echo $T_DIR # need to hardcode to test 
SFILE="/home/vivek/.config/qtile/themes/system.ini"
RFILE="/home/vivek/.config/qtile/themes/.system"
STYLE="default"
echo "1"
